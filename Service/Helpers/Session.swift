...
class Session {
    @discardableResult func sessionRequest(data: NSDictionary, to: String, method: String,
                                           completionHandler: @escaping (NSDictionary?, Error?) -> Void) -> URLSessionDataTask {

        let url = URL(string: "\(AppConstants.api)/\(to)"
...
//
//    func imageUpload(data: [String: Any],
//                     image: UIImage,
//                     objectName: String,
//                     imageName: String,
//                     to: String,
//                     completionHandler: @escaping (NSDictionary?, Error?) -> Void) {
//
//        let url = URL(string: "\(AppConstants.api())/\(to)"
//            .addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)!)
//        var request = URLRequest(url:url!)
